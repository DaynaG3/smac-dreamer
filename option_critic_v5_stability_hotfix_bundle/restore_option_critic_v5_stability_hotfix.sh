...
BACKUP="${1:?usage: restore_option_critic_v5_stability_hotfix.sh BACKUP_DIR REPO}"
REPO="${2:?usage: restore_option_critic_v5_stability_hotfix.sh BACKUP_DIR REPO}"
PY="${PY:-python}"
MANIFEST="$BACKUP/option_critic_v5_stability_backup_manifest.json"
...
print('[OK] restored pre-v5-stability files and removed introduced files')
PY
