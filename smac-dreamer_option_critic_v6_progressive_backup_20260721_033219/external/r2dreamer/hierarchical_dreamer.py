...
def load_hierarchical_compatible_state(
    ...
    *,
    ...
    with torch.no_grad():
        ...
        # Expand each competent source mode into an equal number of exact copies. With
    ...
    return {
        ...
        "migration_layout": (
            ...
            if target.num_options // 2 == 4
            else f"{target.num_options // 2}_exact_copies_per_v1_2_mode"
        ),
