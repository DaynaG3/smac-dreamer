...
class HierarchicalOptionSettings:
    ...
    manager_unimix_final: float = 0.01
    ...
    # The v5 stability run keeps exactly the two competent source modes.
    # Grouping remains explicit so routing trust-region code has one stable
    # contract across migration, training, and checkpoint audits.
