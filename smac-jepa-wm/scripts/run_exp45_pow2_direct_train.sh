...
[[ -f smac_jepa/train_jepa_exp45_pow2_direct.py ]] || fail "Install the Exp45 bundle first"
...
python -m smac_jepa.train_jepa_exp45_pow2_direct \
...
python tools/audit_exp45_pow2_checkpoint.py "$OUT_DIR/checkpoint.pt"
